...
abstract public class MIDINotification {
  ...
  public static MIDINotification fromNative(Pointer p, int offset) {
    MIDINotificationMessageID type =
        MIDINotificationMessageID.byValue(p.getInt(offset));
    offset += 4;
  ...
  abstract public static class ObjectAddedOrRemoved extends MIDINotification {
    ...
    public ObjectAddedOrRemoved(MIDINotificationMessageID type, int parent,
        MIDIObjectType parentType, int child, MIDIObjectType childType) {
      super(type);
      this.parent = parent;
  ...
  public static class ObjectAdded
      extends MIDINotification.ObjectAddedOrRemoved {
    public ObjectAdded(int parent, MIDIObjectType parentType, int child,
        MIDIObjectType childType) {
      super(MIDINotificationMessageID.kMIDIMsgObjectAdded, parent, parentType,
          child, childType);
    }
  ...
  public static class ObjectRemoved
      extends MIDINotification.ObjectAddedOrRemoved {
    public ObjectRemoved(int parent, MIDIObjectType parentType, int child,
        MIDIObjectType childType) {
      super(MIDINotificationMessageID.kMIDIMsgObjectRemoved, parent, parentType,
          child, childType);
    }
  ...
  public static class PropertyChanged extends MIDINotification {
    ...
    public PropertyChanged(int object, MIDIObjectType objectType,
        String propertyName) {
