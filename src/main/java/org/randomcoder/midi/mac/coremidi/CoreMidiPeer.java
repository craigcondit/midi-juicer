...
public interface CoreMidiPeer extends Library {
  ...
  public int MIDIInputPortCreate(int client, CFStringRef portName,
      MIDIReadProc readProc, Pointer refCon, IntByReference outPort);

  public int MIDIOutputPortCreate(int client, CFStringRef portName,
  ...
  public Pointer MIDIPacketListAdd(Pointer pktlist, int listSize,
  ...
  public int MIDIObjectFindByUniqueID(int inUniqueID, IntByReference outObject,
      IntByReference outObjectType);

  public int MIDIObjectGetIntegerProperty(int obj, CFStringRef propertyID,
      Pointer outValue);

  public int MIDIObjectGetStringProperty(int obj, CFStringRef propertyID,
      Pointer str);

  public int MIDIObjectRemoveProperty(int obj, CFStringRef propertyID);

  public int MIDIObjectSetIntegerProperty(int obj, CFStringRef propertyID,
      int value);

  public int MIDIObjectSetStringProperty(int obj, CFStringRef propertyID,
      CFStringRef str);
  ...
  public int MIDIDestinationCreate(int client, CFStringRef name,
  ...
  public int MIDISourceCreate(int client, CFStringRef name,
  ...
  public int MIDIClientCreate(CFStringRef name, MIDINotifyProc notifyProc,
      Pointer notifyRefCon, IntByReference outClient);
