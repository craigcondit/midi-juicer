...
public class PropUtils {
  ...
  public static DoubleProperty doubleProperty(Object bean, String name,
      double initialValue) {
  ...
  public static <T> ObjectProperty<T> objectProperty(Object bean, String name,
      T initialValue) {
  ...
  public static <T> ObjectProperty<T> objectProperty(Object bean, String name,
      T initialValue, Consumer<T> invalidated) {
