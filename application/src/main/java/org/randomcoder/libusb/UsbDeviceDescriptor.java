...
public class UsbDeviceDescriptor extends Structure {
  ...
  @Override protected List<String> getFieldOrder() {
    return Arrays.asList("bLength", "bDescriptorType", "bcdUSB", "bDeviceClass",
        "bDeviceSubClass", "bDeviceProtocol", "bMaxPacketSize0", "idVendor",
        "idProduct", "bcdDevice", "iManufacturer", "iProduct", "iSerial",
        "bNumConfigurations");
  }
  ...
  @Override public String toString() {
    ...
    buf.append(String
        .format("  bcdUSB             %6s%n", BcdUtils.decodeBcdUsb(bcdUSB)));
    ...
    buf.append(String.format("  bcdDevice          %6s%n",
        BcdUtils.decodeBcdUsb(bcdDevice)));
    ...
    buf.append(
        String.format("  bNumConfigurations    %3d", bNumConfigurations));
    return buf.toString();
  }
}
