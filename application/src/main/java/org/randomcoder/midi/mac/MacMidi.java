...
public class MacMidi {
  ...
  private static final Set<Consumer<MIDINotification.SetupChanged>>
      setupChangedListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.ObjectAdded>>
      objectAddedListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.ObjectRemoved>>
      objectRemovedListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.PropertyChanged>>
      propertyChangedListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.IOError>>
      ioErrorListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.ThruConnectionsChanged>>
      thruConnectionsChangedListeners = new LinkedHashSet<>();
  private static final Set<Consumer<MIDINotification.SerialPortOwnerChanged>>
      serialPortOwnerChangedListeners = new LinkedHashSet<>();

  private static final AtomicReference<Boolean> available =
  ...
  private static void handleObjectRemoved(
      MIDINotification.ObjectRemoved event) {
  ...
  private static void handlePropertyChanged(
      MIDINotification.PropertyChanged event) {
    List<Consumer<MIDINotification.PropertyChanged>> handlers =
        new ArrayList<>();
    synchronized (lock) {
  ...
  private static void handleThruConnectionsChanged(
      MIDINotification.ThruConnectionsChanged event) {
    List<Consumer<MIDINotification.ThruConnectionsChanged>> handlers =
        new ArrayList<>();
    synchronized (lock) {
  ...
  private static void handleSerialPortOwnerChanged(
      MIDINotification.SerialPortOwnerChanged event) {
    List<Consumer<MIDINotification.SerialPortOwnerChanged>> handlers =
        new ArrayList<>();
    synchronized (lock) {
  ...
  public static void addSetupChangedListener(
      Consumer<MIDINotification.SetupChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeSetupChangedListener(
      Consumer<MIDINotification.SetupChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addObjectAddedListener(
      Consumer<MIDINotification.ObjectAdded> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeObjectAddedListener(
      Consumer<MIDINotification.ObjectAdded> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addObjectRemovedListener(
      Consumer<MIDINotification.ObjectRemoved> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeObjectRemovedListener(
      Consumer<MIDINotification.ObjectRemoved> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addPropertyChangedListener(
      Consumer<MIDINotification.PropertyChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removePropertyChangedListener(
      Consumer<MIDINotification.PropertyChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addIOErrorListener(
      Consumer<MIDINotification.IOError> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeIOErrorListener(
      Consumer<MIDINotification.IOError> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addThruConnectionsChangedListener(
      Consumer<MIDINotification.ThruConnectionsChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeThruConnectionsChangedListener(
      Consumer<MIDINotification.ThruConnectionsChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void addSerialPortOwnerChangedListener(
      Consumer<MIDINotification.SerialPortOwnerChanged> handler) {
    init();
    synchronized (lock) {
  ...
  public static void removeSerialPortOwnerChangedListener(
      Consumer<MIDINotification.SerialPortOwnerChanged> handler) {
    init();
    synchronized (lock) {
  ...
  private static void handleMidiNotification(Pointer nRef, Pointer context) {
    ...
    case kMIDIMsgSerialPortOwnerChanged:
      handleSerialPortOwnerChanged(
          (MIDINotification.SerialPortOwnerChanged) notification);
      break;
    case kMIDIMsgSetupChanged:
      handleSetupChanged((MIDINotification.SetupChanged) notification);
      break;
    case kMIDIMsgThruConnectionsChanged:
      handleThruConnectionsChanged(
          (MIDINotification.ThruConnectionsChanged) notification);
      break;
    default:
      break;
    }
  ...
  public static void init() {
    ...
    synchronized (lock) {
      ...
      Runtime.getRuntime()
          .addShutdownHook(new Thread(() -> shutdownInternal(true)));

      RunLoop.getDefault().orElseThrow(
          () -> new IllegalStateException("Default runloop not set"))
          .invokeAndWait(() -> {
            clientId = CoreMidi.getInstance()
                .createClient("MacMidiNotifications",
                    MacMidi::handleMidiNotification);
  ...
  public static void shutdown() {
    synchronized (lock) {
      ...
      if (clientId != Integer.MIN_VALUE) {
        RunLoop.getDefault().ifPresentOrElse(t -> shutdownInternal(false),
  ...
  public static boolean isMacMidiDevice(MidiDevice device) {
    return MacMidiDeviceProvider.getInstance()
        .isDeviceSupported(device.getDeviceInfo());
  }

  public static MidiDevice createVirtualSource(String name, String vendor,
      String description, String version) {
    return MacMidiDeviceProvider.getInstance()
        .createVirtualSource(name, vendor, description, version);
  }

  public static MidiDevice createVirtualDestination(String name, String vendor,
      String description, String version) {
    return MacMidiDeviceProvider.getInstance()
        .createVirtualDestination(name, vendor, description, version);
  }
