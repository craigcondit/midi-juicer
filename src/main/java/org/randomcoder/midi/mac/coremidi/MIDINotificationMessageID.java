...
public enum MIDINotificationMessageID {
    kMIDIMsgUnknown(-1, (p, o, l) -> new MIDINotification.Unknown()), kMIDIMsgSetupChanged(1,
	    (p, o, l) -> new MIDINotification.SetupChanged()), kMIDIMsgObjectAdded(2, (p, o, l) -> {
		if (l < 16) {
		...
		return new MIDINotification.PropertyChanged(
		    ...
		    (p, o, l) -> new MIDINotification.ThruConnectionsChanged()), kMIDIMsgSerialPortOwnerChanged(6,
			    (p, o, l) -> new MIDINotification.SerialPortOwnerChanged()), kMIDIMsgIOError(7,
				    (p, o, l) -> {
					if (l < 8) {
					    // invalid size, just ignore it
					    return new MIDINotification.Unknown();
