...
public class MidiVirtualSource {
	...
	private static final Logger LOG = LoggerFactory.getLogger(MidiVirtualSource.class);
	...
	public static void main(String[] args) throws Exception {
		...
		try (RunLoop rl = RunLoop.spawn(true)) {
			...
			try (MidiDevice device = MacMidi.createVirtualSource(
					"Input 1", "RandomCoder", "RandomCoder Input 1", "1.0.0");
