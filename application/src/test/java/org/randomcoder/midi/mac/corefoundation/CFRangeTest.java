...
public class CFRangeTest {
  ...
  @Test public void emptyConstructorCreatesEmptyObject() {
    CFRange obj = new CFRange();
    assertEquals(0L, obj.loc);
    assertEquals(0L, obj.len);
  }

  @Test public void pointerConstructorInitializesObjectFromMemory() {
  ...
  @Test public void valueConstructorCreatesPopulatedObject() {
    CFRange obj = new CFRange(111L, 222L);
    assertEquals(111L, obj.loc);
    assertEquals(222L, obj.len);
  }

  @Test public void byReferenceEmptyConstructorCreatesEmptyObject() {
    CFRange obj = new CFRange.ByReference();
    assertEquals(0L, obj.loc);
    assertEquals(0L, obj.len);
  }

  @Test public void byReferenceCopyConstructorCreatesEquivalentObject() {
  ...
  @Test public void byValueEmptyConstructorCreatesEmptyObject() {
    CFRange obj = new CFRange.ByValue();
    assertEquals(0L, obj.loc);
    assertEquals(0L, obj.len);
  }

  @Test public void byValueCopyConstructorCreatesEquivalentObject() {
    CFRange src = new CFRange(1L, 2L);
    src.write();
