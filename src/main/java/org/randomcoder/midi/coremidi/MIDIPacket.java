...
public class MIDIPacket {
     ...
     * MIDI, the time at which the events are to be played. Zero means "now." The
     * time stamp applies to the first MIDI byte in the packet.
     */
     ...
     * message, or portion of one, with no other MIDI events.
     */
