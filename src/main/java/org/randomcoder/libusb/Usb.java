...
public class Usb {
	...
	public UsbDeviceDescriptors getDeviceDescriptors(Pointer context) throws UsbException {
		UsbPeer peer = peer();
	...
	public Pointer openDevice(UsbDeviceDescriptor descriptor) throws UsbException {
	...
	public void claimInterface(Pointer handle, int interfaceNumber) throws UsbException {
	...
	public void releaseInterface(Pointer handle, int interfaceNumber) throws UsbException {
	...
	public void bulkTransfer(
		...
		int result = peer().libusb_bulk_transfer(
				deviceHandle, endpoint, buffer, length, transferred, timeout);
