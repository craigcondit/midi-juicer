...
public enum MIDIObjectType {
    kMIDIObjectType_Other(-1), kMIDIObjectType_Device(0), kMIDIObjectType_Entity(1), kMIDIObjectType_Source(
	    2), kMIDIObjectType_Destination(3), kMIDIObjectType_ExternalDevice(0x10), kMIDIObjectType_ExternalEntity(
		    0x11), kMIDIObjectType_ExternalSource(0x12), kMIDIObjectType_ExternalDestination(0x13);
